...
45 years for which the detailed accounts exist, which is why the
...
\begin{table}[htbp]
\centering
\caption{The five largest annual improvements and the five largest deteriorations, ranked by the change scaled by current-year GDP, with the subsector that accounts for most of each move.}
\label{tab:movements}
\small
\fitwidth{%
\begin{tabular}{@{}lrrrrrrlr@{}}
\toprule
Direction & Year & Aggregate change (\% GDP) & Aggregate change (M EUR) & Central (M EUR) & Regional/local (M EUR) & SSF (M EUR) & Largest contributor & Its share of the move \\
\midrule
Improvement & 2011 & 3.92 & 6,913 & 5,937 & 1,342 & -366 & Central Government & 0.86 \\
Improvement & 2015 & 2.63 & 4,726 & 4,283 & 121 & 321 & Central Government & 0.91 \\
Improvement & 2021 & 2.52 & 5,447 & 5,570 & -394 & 270 & Central Government & 1.02 \\
Improvement & 1986 & 2.52 & 633 & 355 & 97 & 181 & Central Government & 0.56 \\
Improvement & 2018 & 2.44 & 4,997 & 5,053 & 151 & -208 & Central Government & 1.01 \\
Deterioration & 2009 & -5.98 & -10,496 & -8,939 & -289 & -1,268 & Central Government & -0.85 \\
Deterioration & 2020 & -5.88 & -11,813 & -10,224 & -811 & -777 & Central Government & -0.87 \\
Deterioration & 1981 & -5.40 & -478 & -385 & -48 & -45 & Central Government & -0.81 \\
Deterioration & 1984 & -4.71 & -790 & -922 & -1 & 133 & Central Government & -1.17 \\
Deterioration & 1980 & -4.02 & -296 & -233 & -34 & -29 & Central Government & -0.79 \\
\bottomrule
\end{tabular}%
}
\par\smallskip
\begin{minipage}{\linewidth}\footnotesize\itshape Scaling by current-year GDP shares one denominator across the three subsector terms, so the decomposition stays exact; it is not the change in the balance ratio, which would also move with the denominator. 1995 is excluded because the 1994-to-1995 change straddles the vintage splice in both panels.\end{minipage}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{The same ten episodes as in Table~\ref{tab:movements}, split into the revenue and expenditure movements that produced them.}
\label{tab:revexpepisodes}
\small
\fitwidth{%
\begin{tabular}{@{}lrrrrr@{}}
\toprule
Direction & Year & Change in balance (M EUR) & From revenue (M EUR) & From expenditure (M EUR) & Source-family residual (M EUR) \\
\midrule
Improvement & 2011 & 6,913 & 1,796 & -5,117 & -0 \\
Improvement & 2015 & 4,726 & 1,854 & -2,871 & 0 \\
Improvement & 2021 & 5,447 & 9,188 & 3,742 & 0 \\
Improvement & 1986 & 633 & 2,092 & 1,458 & 0 \\
Improvement & 2018 & 4,997 & 4,794 & -203 & 0 \\
Deterioration & 2009 & -10,496 & -3,802 & 6,694 & -0 \\
Deterioration & 2020 & -11,813 & -4,176 & 7,636 & -0 \\
Deterioration & 1981 & -478 & 573 & 1,051 & 0 \\
Deterioration & 1984 & -790 & 943 & 1,733 & 0 \\
Deterioration & 1980 & -296 & 523 & 819 & 0 \\
\bottomrule
\end{tabular}%
}
\par\smallskip
\begin{minipage}{\linewidth}\footnotesize\itshape A balance improves when revenue rises faster than expenditure, so a positive expenditure column alongside a positive balance change means expenditure grew but grew less. The residual column is the gap between this account-panel measure of the annual change and the canonical balance-panel measure of the same change: the two come from different source families and are not forced to agree.\end{minipage}
\end{table}
