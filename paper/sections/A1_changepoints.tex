...
\begin{itemize}
\item \path{outputs/tables/structural_break_sensitivity.csv};
\item \path{outputs/tables/structural_break_bic_ladder.csv};
\item \path{outputs/tables/structural_break_stability.csv}.
\end{itemize}
