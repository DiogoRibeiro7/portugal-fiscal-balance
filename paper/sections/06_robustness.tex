...
For the Social Security side specifically, that gap is closed rather than left open.
...
rather than to aggregate nominal growth. The regressor there is a quantity the levy
actually falls on, and the fit is an order of magnitude tighter than the specification
criticised here.
