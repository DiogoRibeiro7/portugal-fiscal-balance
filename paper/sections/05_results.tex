...
What the decomposition does not do is explain the movement. A contributory balance
responds to employment, wages, contribution rates, entitlement rules and demographics
at once, and separating those requires a model of the contribution base that this
paper does not build. Section~\ref{sec:robustness} says what such a specification
would look like.
