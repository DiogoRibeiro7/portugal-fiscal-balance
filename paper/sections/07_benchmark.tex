...
\textbf{Coverage is made comparable.} A country-year enters only if all four required
sectors are reported, and a reporter enters the summary only with at least fifteen
complete years. A frequency computed over a handful of years is not comparable with one
computed over thirty. This leaves \BenchmarkCountries\ reporters over
