...
\item \textbf{A contribution base for the Social Security results.} An exact
decomposition of the change in contributions into the movement of the wage bill and the
movement of the effective ratio, and of the wage bill into employment and average wages.
This is what takes the Social Security findings from an accounting location to a named
quantity outside the fiscal accounts.
