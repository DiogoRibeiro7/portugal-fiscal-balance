...
algebraically associated with growth in the wage bill rather than with movement in the
contributions-to-wage-bill ratio. Of the \BaseContributionsChange\ million euro rise in
\BaseYear, \BaseFromWageBill\ million is the wage-bill component, \BaseFromRate\ million
the ratio component and \BaseRatioInteraction\ million their interaction; within the
wage-bill component, \BaseFromAverageWage\ million came from higher average wages against
\BaseFromEmployment\ million from more employees, with \BaseWageInteraction\ million of
interaction. That is a mechanism in the accounting sense --- it names the quantity the
contributions followed --- and not a causal account of why that quantity moved.
